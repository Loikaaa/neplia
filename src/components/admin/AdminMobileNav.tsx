...
import { Menu, LayoutDashboard, Users, FileText, BookOpen, Settings, FileImage, PenTool, Megaphone } from 'lucide-react';
...
interface AdminMobileNavProps {
  ...
  getAdminRoleBadgeColor: (role: AdminRole) => string;
}
