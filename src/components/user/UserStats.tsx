    ...
    <Card className="w-full shadow-sm">
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="flex flex-col items-center justify-center p-4 bg-indigo-50 dark:bg-gray-800 rounded-lg">
            <Target className="h-10 w-10 text-indigo mb-3" />
          ...
          <div className="flex flex-col items-center justify-center p-4 bg-teal-50 dark:bg-gray-800 rounded-lg">
            <Zap className="h-10 w-10 text-teal mb-3" />
          ...
          <div className="flex flex-col items-center justify-center p-4 bg-coral-50 dark:bg-gray-800 rounded-lg">
            <Clock className="h-10 w-10 text-coral mb-3" />
        ...
        <div className="mt-6 space-y-4">
          <div className="space-y-2">
            ...
            <div className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
              <div className="bg-indigo h-full rounded-full" style={{ width: '70%' }}></div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
              <div className="bg-teal h-full rounded-full" style={{ width: '65%' }}></div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
              <div className="bg-coral h-full rounded-full" style={{ width: '60%' }}></div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
              <div className="bg-indigo h-full rounded-full" style={{ width: '75%' }}></div>
            </div>
          </div>
        </div>
      </CardContent>
