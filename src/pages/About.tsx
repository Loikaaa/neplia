  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        {/* Hero Section */}
        <EditableSection pageId="about" sectionName="hero" title content>
        ...
        {/* Our Story */}
        <EditableSection pageId="about" sectionName="story" title content>
        ...
        {/* Team Tuit */}
        <EditableSection pageId="about" sectionName="team" title content>
          <div className="flex items-center mb-6">
        ...
        {/* Our Approach */}
        <EditableSection pageId="about" sectionName="approach" title content>
          <div className="flex items-center mb-6">
        ...
        {/* Achievements */}
        <EditableSection pageId="about" sectionName="achievements" title content>
          <div className="flex items-center mb-6">
        ...
        {/* Mission and Values */}
        <EditableSection pageId="about" sectionName="mission" title content>
          <div className="flex items-center mb-6">
            <Star className="h-8 w-8 text-indigo mr-3" />
        ...
        {/* Get in Touch */}
        <EditableSection pageId="about" sectionName="contact" title content>
          <div className="flex items-center mb-6">
            <Info className="h-8 w-8 text-indigo mr-3" />
